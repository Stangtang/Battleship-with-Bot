...
Special_Key get_special_keystroke() {
    ...
    if (ch == 0 || ch == 224) {
        switch (_getch()) {
        case 72:
            return Special_Key::Up_Arrow;
        case 80:
            return Special_Key::Down_Arrow;
        case 75:
            return Special_Key::Left_Arrow;
        case 77:
            return Special_Key::Right_Arrow;
        }
    }
        ...
        if (ready <= 0) {
            ...
            if (read(STDIN_FILENO, &seq[0], 1) == 1 &&
                ...
                if (seq[0] == '[') {
                    switch (seq[1]) {
                    case 'A':
                        result = Special_Key::Up_Arrow;
                        break;
                    case 'B':
                        result = Special_Key::Down_Arrow;
                        break;
                    case 'C':
                        result = Special_Key::Right_Arrow;
                        break;
                    case 'D':
                        result = Special_Key::Left_Arrow;
                        break;
                    default:
                        result = Special_Key::Not_Recognized;
                    }
                } else {
                    result = Special_Key::Escape;
                }
